...
try
{
    ...
    // Create the LimDB context with proper disposal
    using var db = await LimDbContext<Product>.CreateFromLocalStorageSourceAsync(dbFileName);
...
{
    Console.WriteLine($"Error: Database file not found - {ex.Message}");
}
